...
export function CalendarView({
  ...
  const getEventsForDay = (day: Date) => {
    ...
    return { reservas: dayReservas, bloqueios: dayBloqueios };
  };
    ...
    <div>
      ...
      <div className="grid grid-cols-7 gap-2">
        {days.map((day) => {
          ...
          const hasEvents = dayEvents.reservas.length > 0 || dayEvents.bloqueios.length > 0;
          ...
          return (
            ...
            >
              ...
              <div className="space-y-1">
                ...
                {dayEvents.reservas.length > 2 && (
                  <div className="text-xs text-muted-foreground">
                    +{dayEvents.reservas.length - 2} mais
                  </div>
                )}
