...
export function useLocaisAtendimento() {
  ...
  const fetchLocais = useCallback(async () => {
    try {
      ...
      // Usar dados hardcoded por enquanto para garantir que a legenda apareça
      console.log('Usando dados hardcoded dos locais de atendimento');
      ...
      console.warn('Erro ao carregar locais, usando dados hardcoded:', err);
